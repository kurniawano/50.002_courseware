...
//	new Macro(symbols,"BEQ","RA","LABEL","betabr(0x1C,RA,R31,LABEL)");
	new Macro(symbols,"BEQ","RA","LABEL","RC","betabr(0x1D,RA,RC,LABEL)");
	new Macro(symbols,"BEQ","RA","LABEL","betabr(0x1D,RA,R31,LABEL)");
...
//	new Macro(symbols,"BNE","RA","LABEL","betabr(0x1D,RA,R31,LABEL)");
	new Macro(symbols,"BNE","RA","LABEL","RC","betabr(0x1E,RA,RC,LABEL)");
	new Macro(symbols,"BNE","RA","LABEL","betabr(0x1E,RA,R31,LABEL)");
